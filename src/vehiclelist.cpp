 ...
 */
uint64_t VehicleListIdentifier::Pack() const
{
 ...
 */
bool VehicleListIdentifier::UnpackIfValid(uint64_t data)
{
 ...
 * @param data The data to unpack.
 */
/* static */ VehicleListIdentifier VehicleListIdentifier::UnPack(uint64_t data)
{
